        ...
        <div className="profile-info">
          ...
          <div className="profile-links">
            <a href="mailto:takuyahirata4@gmail.com">
              <MdContactMail className="profile-icon" />
            </a>
            <a
            ...
            >
              <FaGithub className="profile-icon center" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <FaLinkedinIn className="profile-icon" />
            </a>
          </div>
        </div>
        ...
        <div className="todo-list-wrapper">
          <div>
            ...
            <div>
              <h3>CODE</h3>
              <p>
                Write clean, understandable, and maintainable code. Good
                applications need to be well organized and tested.
              </p>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div>
              <h3>LEARN</h3>
              <p>
                Stay up-to-date to build great applications. Never stop
                learning!
              </p>
            </div>
          </div>
          <div>
            ...
            <div>
              <h3>COMMUNICATE</h3>
              <p>
                Communicate with team and clients. Talk to other developers by
                attending meetups. It's helpful and fun!
              </p>
            </div>
          </div>
        </div>
